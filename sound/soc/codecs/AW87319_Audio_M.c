...
int aw87319_rst;
extern struct pinctrl *aw87319ctrl;
//struct pinctrl_state *aw87319_rst_high = NULL;
//struct pinctrl_state *aw87319_rst_low = NULL;

//extern struct pinctrl_state *aw87319_rst_high;
//extern struct pinctrl_state *aw87319_rst_low;
...
/*	aw87319ctrl = devm_pinctrl_get(dev);
	...
	aw87319_rst_high = pinctrl_lookup_state(aw87319ctrl, "i2c_8_active");
	if (IS_ERR(aw87319_rst_high)) {
		ret = PTR_ERR(aw87319_rst_high);
		printk("%s : pinctrl err, aw87319_rst_high\n", __func__);
	}

	aw87319_rst_low = pinctrl_lookup_state(aw87319ctrl, "i2c_8_sleep");
